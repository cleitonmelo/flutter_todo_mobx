...
mixin _$ListStore on _ListStore, Store {
  Computed<bool> _$isNotEmptyTitleComputed;

  @override
  bool get isNotEmptyTitle =>
      (_$isNotEmptyTitleComputed ??= Computed<bool>(() => super.isNotEmptyTitle,
              name: '_ListStore.isNotEmptyTitle'))
          .value;
...
isNotEmptyTitle: ${isNotEmptyTitle}
    ''';
  }
}
